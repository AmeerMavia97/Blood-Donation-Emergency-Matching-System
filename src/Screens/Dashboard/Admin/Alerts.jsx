...
const Alerts = () => (
  <DashboardLayout roleName={roleName} tabs={tabs} title="Alerts" description="Monitor duplicate requests, fake requests and expired cases.">
    <DataPanel title="System alerts">
      <RequestRow group="B+" title="Duplicate request warning" meta="Similar patient and hospital data detected" status="Duplicate" tone="red" />
      <RequestRow group="A-" title="Expired request" meta="No donor accepted before timeout" status="Expired" tone="gray" />
    </DataPanel>
  </DashboardLayout>
)
